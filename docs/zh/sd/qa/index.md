...
答: 有的，为方便制作启动盘已与 FirPE 写入程序合并。打开 KnopiaPE 安装包点击“生成 ISO”按钮，选择 ISO 文件位置，即可生成 ISO 文件进行镜像刻录、虚拟机测试等操作。
...
### 问: KnopiaPE 内核是哪里来的？是修改别人的吗？

答: Win11PE 采用 Win10XPE 生成，Win03 修改自 USBOS 内核。

### 问: KnopiaPE 有没有后门/暗柱之类的？初始化配置有没有加密？为什么里面的文件杀毒软件会报毒？
